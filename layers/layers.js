...
//ol.proj.get("EPSG:4674").setExtent([-49.399982, -11.010073, -34.709031, -2.464018]);
var wms_layers = [];
    ...
    attributions: ' &middot; <a href="https://www.google.at/permissions/geoguidelines/attr-guide.html">Mapa Google Satélite</a>',
...
var format_LinhasdetransmissaoPI_8 = new ol.format.GeoJSON();
var features_LinhasdetransmissaoPI_8 = format_LinhasdetransmissaoPI_8.readFeatures(json_LinhasdetransmissaoPI_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4674'});
var jsonSource_LinhasdetransmissaoPI_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LinhasdetransmissaoPI_8.addFeatures(features_LinhasdetransmissaoPI_8);
var lyr_LinhasdetransmissaoPI_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LinhasdetransmissaoPI_8, 
                style: style_LinhasdetransmissaoPI_8,
                popuplayertitle: "Linhas de transmissao PI",
                interactive: true,
    title: 'Linhas de transmissao PI<br />\
    <img src="styles/legend/LinhasdetransmissaoPI_8_0.png" /> 230<br />\
    <img src="styles/legend/LinhasdetransmissaoPI_8_1.png" /> 500<br />\
    <img src="styles/legend/LinhasdetransmissaoPI_8_2.png" /> <br />'
        });
var format_Empreendimentos_9 = new ol.format.GeoJSON();
var features_Empreendimentos_9 = format_Empreendimentos_9.readFeatures(json_Empreendimentos_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4674'});
var jsonSource_Empreendimentos_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Empreendimentos_9.addFeatures(features_Empreendimentos_9);
var lyr_Empreendimentos_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Empreendimentos_9, 
                style: style_Empreendimentos_9,
                popuplayertitle: "Empreendimentos",
                interactive: true,
    title: 'Empreendimentos<br />\
    <img src="styles/legend/Empreendimentos_9_0.png" /> Construção - Eólica<br />\
    <img src="styles/legend/Empreendimentos_9_1.png" /> Construção - Solar<br />\
    <img src="styles/legend/Empreendimentos_9_2.png" /> Construção não iniciada - Eólica<br />\
    <img src="styles/legend/Empreendimentos_9_3.png" /> Construção não iniciada - Solar<br />\
    <img src="styles/legend/Empreendimentos_9_4.png" /> Operação - Biomassa<br />\
    <img src="styles/legend/Empreendimentos_9_5.png" /> Operação - Eólica<br />\
    <img src="styles/legend/Empreendimentos_9_6.png" /> Operação - Fóssil<br />\
    <img src="styles/legend/Empreendimentos_9_7.png" /> Operação - Hídrica<br />\
    <img src="styles/legend/Empreendimentos_9_8.png" /> Operação - Solar<br />\
    <img src="styles/legend/Empreendimentos_9_9.png" /> <br />'
        });
var format_Linha_Frigorfico_10 = new ol.format.GeoJSON();
var features_Linha_Frigorfico_10 = format_Linha_Frigorfico_10.readFeatures(json_Linha_Frigorfico_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4674'});
var jsonSource_Linha_Frigorfico_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Linha_Frigorfico_10.addFeatures(features_Linha_Frigorfico_10);
var lyr_Linha_Frigorfico_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Linha_Frigorfico_10, 
                style: style_Linha_Frigorfico_10,
                popuplayertitle: "Linha_Frigorífico",
                interactive: true,
                title: '<img src="styles/legend/Linha_Frigorfico_10.png" /> Linha_Frigorífico'
            });
var format_Empreendimentos_INFRA_11 = new ol.format.GeoJSON();
var features_Empreendimentos_INFRA_11 = format_Empreendimentos_INFRA_11.readFeatures(json_Empreendimentos_INFRA_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4674'});
var jsonSource_Empreendimentos_INFRA_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Empreendimentos_INFRA_11.addFeatures(features_Empreendimentos_INFRA_11);
var lyr_Empreendimentos_INFRA_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Empreendimentos_INFRA_11, 
                style: style_Empreendimentos_INFRA_11,
                popuplayertitle: "Empreendimentos_INFRA",
                interactive: true,
                title: '<img src="styles/legend/Empreendimentos_INFRA_11.png" /> Empreendimentos_INFRA'
            });
var format_SubestaesPI_12 = new ol.format.GeoJSON();
var features_SubestaesPI_12 = format_SubestaesPI_12.readFeatures(json_SubestaesPI_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4674'});
var jsonSource_SubestaesPI_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SubestaesPI_12.addFeatures(features_SubestaesPI_12);
var lyr_SubestaesPI_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SubestaesPI_12, 
                style: style_SubestaesPI_12,
                popuplayertitle: "Subestações PI",
                interactive: true,
                title: '<img src="styles/legend/SubestaesPI_12.png" /> Subestações PI'
            });
var format_UsinasPI_13 = new ol.format.GeoJSON();
var features_UsinasPI_13 = format_UsinasPI_13.readFeatures(json_UsinasPI_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4674'});
var jsonSource_UsinasPI_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_UsinasPI_13.addFeatures(features_UsinasPI_13);
var lyr_UsinasPI_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_UsinasPI_13, 
                style: style_UsinasPI_13,
                popuplayertitle: "Usinas PI",
                interactive: true,
                title: '<img src="styles/legend/UsinasPI_13.png" /> Usinas PI'
            });

lyr_GoogleSatellite_0.setVisible(true);lyr_OSMStandard_1.setVisible(true);lyr_Municipios_2.setVisible(true);lyr_readeaplicaodaLeideMataAtlnticaPI_3.setVisible(true);lyr_CorredorEcolgicoConfusesSerradaCapivaraPI_4.setVisible(true);lyr_UnidadesdeConservaoEstadualPI_5.setVisible(true);lyr_UnidadesdeConservaoFederalPIICMBIO2023_6.setVisible(true);lyr_ZonadeAmortecimentodasUCsPI3Km_7.setVisible(true);lyr_LinhasdetransmissaoPI_8.setVisible(true);lyr_Empreendimentos_9.setVisible(true);lyr_Linha_Frigorfico_10.setVisible(true);lyr_Empreendimentos_INFRA_11.setVisible(true);lyr_SubestaesPI_12.setVisible(true);lyr_UsinasPI_13.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_OSMStandard_1,lyr_Municipios_2,lyr_readeaplicaodaLeideMataAtlnticaPI_3,lyr_CorredorEcolgicoConfusesSerradaCapivaraPI_4,lyr_UnidadesdeConservaoEstadualPI_5,lyr_UnidadesdeConservaoFederalPIICMBIO2023_6,lyr_ZonadeAmortecimentodasUCsPI3Km_7,lyr_LinhasdetransmissaoPI_8,lyr_Empreendimentos_9,lyr_Linha_Frigorfico_10,lyr_Empreendimentos_INFRA_11,lyr_SubestaesPI_12,lyr_UsinasPI_13];
...
lyr_LinhasdetransmissaoPI_8.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'INS_ID': 'INS_ID', 'TPEQP_ID': 'TPEQP_ID', 'EQP_ID': 'EQP_ID', 'NOMELONGO': 'NOMELONGO', 'NOMEREDE': 'NOMEREDE', 'AGE_NOME': 'AGE_NOME', 'DTPREVISTA': 'DTPREVISTA', 'STR_DTPREVISTA': 'STR_DTPREVISTA', 'DTENTRADA': 'DTENTRADA', 'STR_DTENTRADA': 'STR_DTENTRADA', 'DTPAR': 'DTPAR', 'STR_DTPAR': 'STR_DTPAR', 'NUMDOC': 'NUMDOC', 'VAL_CORRPROJETOLD': 'VAL_CORRPROJETOLD', 'VAL_CAPACOPERSEMFATORCD': 'VAL_CAPACOPERSEMFATORCD', 'VAL_CAPACOPERLD': 'VAL_CAPACOPERLD', 'VAL_CAPACOPERCOMFATORCD': 'VAL_CAPACOPERCOMFATORCD', 'VAL_FATORLIMITANTELD': 'VAL_FATORLIMITANTELD', 'VAL_FATORLIMITANTECD': 'VAL_FATORLIMITANTECD', 'R': 'R', 'X': 'X', 'S': 'S', 'EXT': 'EXT', 'TPCPR_ID': 'TPCPR_ID', 'VN': 'VN', 'SHAPE.STLength()': 'SHAPE.STLength()', });
lyr_Empreendimentos_9.set('fieldAliases', {'Empreendimento': 'Empreendimento', 'CEG': 'CEG', 'UF': 'UF', 'Fonte': 'Fonte', 'Fase': 'Fase', 'Origem': 'Origem', 'Tipo': 'Tipo', 'Tipo de Atuação': 'Tipo de Atuação', 'Combustível Final': 'Combustível Final', 'Entrada em Operação': 'Entrada em Operação', 'Potência Outorgada (kW)': 'Potência Outorgada (kW)', 'Potência Fiscalizada (kW)': 'Potência Fiscalizada (kW)', 'Garantia Fisica (kW)': 'Garantia Fisica (kW)', 'Geração Qualificada': 'Geração Qualificada', 'Latitude Decimal': 'Latitude Decimal', 'Longitude Decimal': 'Longitude Decimal', 'Início Vigência': 'Início Vigência', 'Fim Vigência': 'Fim Vigência', 'Proprietário / Regime de Exploração': 'Proprietário / Regime de Exploração', 'Sub-Bacia': 'Sub-Bacia', 'Município (s)': 'Município (s)', 'fase_origem': 'fase_origem', });
lyr_Linha_Frigorfico_10.set('fieldAliases', {'id': 'id', });
lyr_Empreendimentos_INFRA_11.set('fieldAliases', {'Item': 'Item', 'Empreendimento': 'Empreendimento', 'Empresa': 'Empresa', 'Município': 'Município', 'Produto': 'Produto', 'Área': 'Área', 'Und.': 'Und.', 'Produção': 'Produção', 'Und._1': 'Und._1', 'Estimativa Potência Necessária': 'Estimativa Potência Necessária', 'Und._2': 'Und._2', 'Licenciamento Ambiental': 'Licenciamento Ambiental', 'Latitude DMS (Y)': 'Latitude DMS (Y)', 'Longitude DMS (X)': 'Longitude DMS (X)', 'LATITUDE (DECIMAL)': 'LATITUDE (DECIMAL)', 'LONGITUDE (DECIMAL)': 'LONGITUDE (DECIMAL)', });
lyr_SubestaesPI_12.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'INS_ID': 'INS_ID', 'NOMELONGO': 'NOMELONGO', 'AGE_ID_PRIN': 'AGE_ID_PRIN', 'AGE_PRIN_NOM': 'AGE_PRIN_NOM', 'DTPREVISTA': 'DTPREVISTA', 'STR_DTPREVISTA': 'STR_DTPREVISTA', 'DTENTRADA': 'DTENTRADA', 'STR_DTENTRADA': 'STR_DTENTRADA', });
lyr_UsinasPI_13.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'INS_ID': 'INS_ID', 'NOM_MODALIDADEOPERUSICONJ': 'NOM_MODALIDADEOPERUSICONJ', 'NOMELONGO': 'NOMELONGO', 'DTPREVISTA': 'DTPREVISTA', 'STR_DTPREVISTA': 'STR_DTPREVISTA', 'DTENTRADA': 'DTENTRADA', 'STR_DTENTRADA': 'STR_DTENTRADA', 'TPUSINA_ID': 'TPUSINA_ID', 'NOME_TPUSINA': 'NOME_TPUSINA', });
...
lyr_LinhasdetransmissaoPI_8.set('fieldLabels', {'OBJECTID': 'hidden field', 'INS_ID': 'hidden field', 'TPEQP_ID': 'hidden field', 'EQP_ID': 'hidden field', 'NOMELONGO': 'no label', 'NOMEREDE': 'no label', 'AGE_NOME': 'no label', 'DTPREVISTA': 'hidden field', 'STR_DTPREVISTA': 'hidden field', 'DTENTRADA': 'hidden field', 'STR_DTENTRADA': 'hidden field', 'DTPAR': 'hidden field', 'STR_DTPAR': 'hidden field', 'NUMDOC': 'hidden field', 'VAL_CORRPROJETOLD': 'hidden field', 'VAL_CAPACOPERSEMFATORCD': 'hidden field', 'VAL_CAPACOPERLD': 'hidden field', 'VAL_CAPACOPERCOMFATORCD': 'hidden field', 'VAL_FATORLIMITANTELD': 'hidden field', 'VAL_FATORLIMITANTECD': 'hidden field', 'R': 'hidden field', 'X': 'hidden field', 'S': 'hidden field', 'EXT': 'hidden field', 'TPCPR_ID': 'hidden field', 'VN': 'inline label - visible with data', 'SHAPE.STLength()': 'hidden field', });
lyr_Empreendimentos_9.set('fieldLabels', {'Empreendimento': 'inline label - visible with data', 'CEG': 'hidden field', 'UF': 'hidden field', 'Fonte': 'hidden field', 'Fase': 'inline label - visible with data', 'Origem': 'inline label - visible with data', 'Tipo': 'hidden field', 'Tipo de Atuação': 'hidden field', 'Combustível Final': 'hidden field', 'Entrada em Operação': 'hidden field', 'Potência Outorgada (kW)': 'inline label - visible with data', 'Potência Fiscalizada (kW)': 'inline label - visible with data', 'Garantia Fisica (kW)': 'hidden field', 'Geração Qualificada': 'hidden field', 'Latitude Decimal': 'hidden field', 'Longitude Decimal': 'hidden field', 'Início Vigência': 'hidden field', 'Fim Vigência': 'inline label - visible with data', 'Proprietário / Regime de Exploração': 'hidden field', 'Sub-Bacia': 'hidden field', 'Município (s)': 'no label', 'fase_origem': 'hidden field', });
lyr_Linha_Frigorfico_10.set('fieldLabels', {'id': 'no label', });
lyr_Empreendimentos_INFRA_11.set('fieldLabels', {'Item': 'hidden field', 'Empreendimento': 'no label', 'Empresa': 'no label', 'Município': 'hidden field', 'Produto': 'inline label - visible with data', 'Área': 'inline label - visible with data', 'Und.': 'no label', 'Produção': 'inline label - visible with data', 'Und._1': 'no label', 'Estimativa Potência Necessária': 'inline label - visible with data', 'Und._2': 'no label', 'Licenciamento Ambiental': 'inline label - visible with data', 'Latitude DMS (Y)': 'no label', 'Longitude DMS (X)': 'no label', 'LATITUDE (DECIMAL)': 'hidden field', 'LONGITUDE (DECIMAL)': 'hidden field', });
lyr_SubestaesPI_12.set('fieldLabels', {'OBJECTID': 'hidden field', 'INS_ID': 'hidden field', 'NOMELONGO': 'no label', 'AGE_ID_PRIN': 'hidden field', 'AGE_PRIN_NOM': 'hidden field', 'DTPREVISTA': 'hidden field', 'STR_DTPREVISTA': 'hidden field', 'DTENTRADA': 'hidden field', 'STR_DTENTRADA': 'hidden field', });
lyr_UsinasPI_13.set('fieldLabels', {'OBJECTID': 'hidden field', 'INS_ID': 'hidden field', 'NOM_MODALIDADEOPERUSICONJ': 'hidden field', 'NOMELONGO': 'no label', 'DTPREVISTA': 'hidden field', 'STR_DTPREVISTA': 'hidden field', 'DTENTRADA': 'hidden field', 'STR_DTENTRADA': 'hidden field', 'TPUSINA_ID': 'hidden field', 'NOME_TPUSINA': 'no label', });
lyr_UsinasPI_13.on('precompose', function(evt) {
