...
//ol.proj.get("EPSG:4674").setExtent([-48.856665, -10.695257, -34.341260, -2.251322]);
var wms_layers = [];
...
var format_SubestaesPI_10 = new ol.format.GeoJSON();
var features_SubestaesPI_10 = format_SubestaesPI_10.readFeatures(json_SubestaesPI_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4674'});
var jsonSource_SubestaesPI_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SubestaesPI_10.addFeatures(features_SubestaesPI_10);
var lyr_SubestaesPI_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SubestaesPI_10, 
                style: style_SubestaesPI_10,
                popuplayertitle: "Subestações PI",
                interactive: true,
                title: '<img src="styles/legend/SubestaesPI_10.png" /> Subestações PI'
            });
var format_UsinasPI_11 = new ol.format.GeoJSON();
var features_UsinasPI_11 = format_UsinasPI_11.readFeatures(json_UsinasPI_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4674'});
var jsonSource_UsinasPI_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_UsinasPI_11.addFeatures(features_UsinasPI_11);
var lyr_UsinasPI_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_UsinasPI_11, 
                style: style_UsinasPI_11,
                popuplayertitle: "Usinas PI",
                interactive: true,
                title: '<img src="styles/legend/UsinasPI_11.png" /> Usinas PI'
            });

lyr_GoogleSatellite_0.setVisible(true);lyr_OSMStandard_1.setVisible(true);lyr_Municipios_2.setVisible(true);lyr_readeaplicaodaLeideMataAtlnticaPI_3.setVisible(true);lyr_CorredorEcolgicoConfusesSerradaCapivaraPI_4.setVisible(true);lyr_UnidadesdeConservaoEstadualPI_5.setVisible(true);lyr_UnidadesdeConservaoFederalPIICMBIO2023_6.setVisible(true);lyr_ZonadeAmortecimentodasUCsPI3Km_7.setVisible(true);lyr_LinhasdetransmissaoPI_8.setVisible(true);lyr_Empreendimentos_9.setVisible(true);lyr_SubestaesPI_10.setVisible(true);lyr_UsinasPI_11.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_OSMStandard_1,lyr_Municipios_2,lyr_readeaplicaodaLeideMataAtlnticaPI_3,lyr_CorredorEcolgicoConfusesSerradaCapivaraPI_4,lyr_UnidadesdeConservaoEstadualPI_5,lyr_UnidadesdeConservaoFederalPIICMBIO2023_6,lyr_ZonadeAmortecimentodasUCsPI3Km_7,lyr_LinhasdetransmissaoPI_8,lyr_Empreendimentos_9,lyr_SubestaesPI_10,lyr_UsinasPI_11];
...
lyr_SubestaesPI_10.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'INS_ID': 'INS_ID', 'NOMELONGO': 'NOMELONGO', 'AGE_ID_PRIN': 'AGE_ID_PRIN', 'AGE_PRIN_NOM': 'AGE_PRIN_NOM', 'DTPREVISTA': 'DTPREVISTA', 'STR_DTPREVISTA': 'STR_DTPREVISTA', 'DTENTRADA': 'DTENTRADA', 'STR_DTENTRADA': 'STR_DTENTRADA', });
lyr_UsinasPI_11.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'INS_ID': 'INS_ID', 'NOM_MODALIDADEOPERUSICONJ': 'NOM_MODALIDADEOPERUSICONJ', 'NOMELONGO': 'NOMELONGO', 'DTPREVISTA': 'DTPREVISTA', 'STR_DTPREVISTA': 'STR_DTPREVISTA', 'DTENTRADA': 'DTENTRADA', 'STR_DTENTRADA': 'STR_DTENTRADA', 'TPUSINA_ID': 'TPUSINA_ID', 'NOME_TPUSINA': 'NOME_TPUSINA', });
...
lyr_SubestaesPI_10.set('fieldImages', {'OBJECTID': 'Range', 'INS_ID': 'TextEdit', 'NOMELONGO': 'TextEdit', 'AGE_ID_PRIN': 'TextEdit', 'AGE_PRIN_NOM': 'TextEdit', 'DTPREVISTA': 'TextEdit', 'STR_DTPREVISTA': 'TextEdit', 'DTENTRADA': 'TextEdit', 'STR_DTENTRADA': 'TextEdit', });
lyr_UsinasPI_11.set('fieldImages', {'OBJECTID': 'Range', 'INS_ID': 'TextEdit', 'NOM_MODALIDADEOPERUSICONJ': 'TextEdit', 'NOMELONGO': 'TextEdit', 'DTPREVISTA': 'TextEdit', 'STR_DTPREVISTA': 'TextEdit', 'DTENTRADA': 'TextEdit', 'STR_DTENTRADA': 'TextEdit', 'TPUSINA_ID': 'TextEdit', 'NOME_TPUSINA': 'TextEdit', });
...
lyr_SubestaesPI_10.set('fieldLabels', {'OBJECTID': 'hidden field', 'INS_ID': 'hidden field', 'NOMELONGO': 'no label', 'AGE_ID_PRIN': 'hidden field', 'AGE_PRIN_NOM': 'hidden field', 'DTPREVISTA': 'hidden field', 'STR_DTPREVISTA': 'hidden field', 'DTENTRADA': 'hidden field', 'STR_DTENTRADA': 'hidden field', });
lyr_UsinasPI_11.set('fieldLabels', {'OBJECTID': 'hidden field', 'INS_ID': 'hidden field', 'NOM_MODALIDADEOPERUSICONJ': 'hidden field', 'NOMELONGO': 'no label', 'DTPREVISTA': 'hidden field', 'STR_DTPREVISTA': 'hidden field', 'DTENTRADA': 'hidden field', 'STR_DTENTRADA': 'hidden field', 'TPUSINA_ID': 'hidden field', 'NOME_TPUSINA': 'no label', });
lyr_UsinasPI_11.on('precompose', function(evt) {
